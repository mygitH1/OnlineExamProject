...
<html>
  <head>
    ...
    <title>My JSP 'paper1.jsp' starting page</title>
...
public abstract class AbstractTest 
{
	...
	<input type="radio" name="2" value="a"/>B.	45 38

 
	<input type="radio" name="2" value="a"/>C.	45 57

 
	<input type="radio" name="2" value="a"/>D.	An exception occurs at runtime.
...
{  
	...
	<input type="radio" name="3" value="a"/>B.	2

 
	<input type="radio" name="3" value="a"/>C.	4
	 
	<input type="radio" name="3" value="a"/>D.	6
...
public class If1 
{
	...
	<input type="radio" name="4" value="a"/>B.	42

 
	<input type="radio" name="4" value="a"/>C.	50
	 
	<input type="radio" name="4" value="a"/>D.	51
...
5.	Suppose that you would like to create an instance of a new Map that has an iteration order that is the same as the iteration order of an existing instance of a Map. Which concrete implementation of the Map interface should be used for the new instance?
	...
	<input type="radio" name="5" value="a"/>B.	HashMap

 
	<input type="radio" name="5" value="a"/>C.	LinkedHashMap

 
	<input type="radio" name="5" value="a"/>D.	The answer depends on the implementation of the existing instance.
